    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-black/40 border border-white/10 rounded-lg p-3 backdrop-blur-sm">
          <span className="font-pixel text-[9px] text-blue-400 uppercase">
            Weekly
          </span>
        ...
        <div className="bg-black/40 border border-white/10 rounded-lg p-3 backdrop-blur-sm">
          <span className="font-pixel text-[9px] text-pink-400 uppercase">
            Jackpot
          </span>
          <div className="font-pixel text-sm text-white mt-1">
      ...
      <button className="w-full bg-[#b8e550] hover:bg-[#c5ed65] text-gray-900 font-pixel text-sm py-3 rounded-lg transition-all">
        CLAIM REWARDS
      </button>
