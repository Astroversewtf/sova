    ...
    <div className="flex items-center justify-center h-full p-6">
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="bg-[#b8e550] hover:bg-[#c5ed65] text-white font-pixel text-xl px-16 py-6 rounded-lg border-2 border-[#a0cc40]/50 shadow-[0_4px_0_#7a9e30] hover:shadow-[0_2px_0_#7a9e30] hover:translate-y-[2px] active:shadow-none active:translate-y-[4px] transition-all animate-play-pulse text-outline"
        >
          PLAY
        </button>
      </div>
